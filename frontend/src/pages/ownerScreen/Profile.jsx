  ...
  return (
    <FormContainer  className="form-container">
      ...
      <div style={{display:'flex',justifyContent:'center',marginTop:'20px'}}>
        <Image style={{width:"90px",marginRight:"10px"}} src= { ownerInfo.image ?`http://localhost:5000/Images/${ownerInfo.image}`:'https://cdn.vectorstock.com/i/preview-1x/99/94/default-avatar-placeholder-profile-icon-male-vector-23889994.jpg'} roundedCircle />
        </div>
