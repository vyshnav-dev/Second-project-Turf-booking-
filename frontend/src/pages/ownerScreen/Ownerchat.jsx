...
function Ownerchat() {
  ...
  useEffect(() => {
    const newSocket = io("https://spexcart.online"); // Adjust the URL to your backend server
  ...
  useEffect(() => {
    ...
    const storedMessages = JSON.parse(
      localStorage.getItem("ownerChatMessages")
    );
